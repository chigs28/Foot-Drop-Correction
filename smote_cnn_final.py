...
path = "C:/Users\BM605/Downloads/FES_DATA"
...
my_history=model.fit(X_train_s, y_train_s,  validation_data=(X_test_s, y_test_s), epochs=12
...
#for i in range(0, 1):
  ...
  # my_model.compile(loss='binary_crossentropy', optimizer='adam', metrics=['accuracy','mse','mae'])
  model.compile(loss='binary_crossentropy', optimizer=Adam(learning_rate=0.001), metrics=['accuracy','mse','mae'])
  my_history=model.fit(X_train, y_train,  validation_data=(X_test, y_test), epochs=12, batch_size=64, verbose=1)
...
my_model_s = KerasClassifier(build_fn = built_classifier, batch_size =100, epochs =12)
